...
use Tests\Fixtures\Tooling\PhpStan\SchemableCollections\WithMissingVersion;
use Tests\Fixtures\Tooling\PhpStan\Schemas\ValidSchema;
use Tests\Fixtures\Tooling\PhpStan\Schemas\ValidSchemaV2;

#[CollectedBy(WithMissingVersion::class)]
#[UseSchema(ValidSchemaV2::class)]
#[UseSchema(ValidSchema::class)]
class CollectedByWithMissingVersion extends Model implements Schemable
{
