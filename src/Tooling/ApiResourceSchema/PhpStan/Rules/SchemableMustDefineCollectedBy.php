...
class SchemableMustDefineCollectedBy extends Rule
{
    public function shouldHandle(Node $node, Scope $scope): bool
    {
        return $this->inherits($node, Schemable::class) && $this->doesNotHaveAttribute($node, CollectedBy::class);
    }
    ...
    public function handle(Node $node, Scope $scope): void
    {
        $this->error(
            ...
            'Schemable.CollectedBy.required'
        );
    }
}
